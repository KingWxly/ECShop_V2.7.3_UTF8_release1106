...
<body>
'<?php echo $this->fetch('.strtolower(library/page_header.lbi).'); ?>'

<div class="block box">
 <div id="ur_here">
  '<?php echo $this->fetch('.strtolower(library/ur_here.lbi).'); ?>'
 </div>
</div>
...
'<?php echo $this->fetch('.strtolower(library/cart.lbi).'); ?>'
'<?php echo $this->fetch('.strtolower(library/category_tree.lbi).'); ?>'
'<?php echo $this->fetch('.strtolower(library/goods_related.lbi).'); ?>'
'<?php echo $this->fetch('.strtolower(library/goods_fittings.lbi).'); ?>'
'<?php echo $this->fetch('.strtolower(library/goods_article.lbi).'); ?>'
'<?php echo $this->fetch('.strtolower(library/goods_attrlinked.lbi).'); ?>'



    
    '<?php echo $this->fetch('.strtolower(library/history.lbi).'); ?>'
  </div>
  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
     ...
     '<?php echo $this->fetch('.strtolower(library/goods_gallery.lbi).'); ?>'
...
'<?php echo $this->fetch('.strtolower(library/goods_tags.lbi).'); ?>'
'<?php echo $this->fetch('.strtolower(library/bought_goods.lbi).'); ?>'
'<?php echo $this->fetch('.strtolower(library/bought_note_guide.lbi).'); ?>'
'<?php echo $this->fetch('.strtolower(library/comments.lbi).'); ?>'
...
<div class="block">
  <div class="box">
   <div class="helpTitBg clearfix">
    '<?php echo $this->fetch('.strtolower(library/help.lbi).'); ?>'
   </div>
  </div>
</div>
<div class="blank"></div>
...
<div class="blank"></div>
'<?php echo $this->fetch('.strtolower(library/page_footer.lbi).'); ?>'
</body>
<script type="text/javascript">
